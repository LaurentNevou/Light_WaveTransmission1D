...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% further improvement would be to implement the wavelength dependency of the 
% optical index. In that way, absorption spectrum and polariton could be computed
